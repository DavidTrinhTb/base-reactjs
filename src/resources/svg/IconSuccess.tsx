...
const IconSuccess: FC = () => (
  <svg width='24' height='24' viewBox='0 0 512 512' xmlns='http://www.w3.org/2000/svg' fill='#009845'>
    ...
    <g id='SVGRepo_iconCarrier'>
      ...
      <g id='Page-1' stroke='none' strokeWidth='1' fill='none' fillRule='evenodd'>
        {' '}
        <g id='add-copy-2' fill='#009845' transform='translate(42.666667, 42.666667)'>
          {' '}
          <path
